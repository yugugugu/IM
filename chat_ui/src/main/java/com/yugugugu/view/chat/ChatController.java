package com.yugugugu.view.chat;

import com.yugugugu.util.CacheUtil;
import com.yugugugu.util.Ids;
import com.yugugugu.view.chat.data.GroupsData;
import com.yugugugu.view.chat.data.RemindCount;
import com.yugugugu.view.chat.data.TalkData;
import com.yugugugu.view.chat.element.group_bar_chat.ElementInfoBox;
import com.yugugugu.view.chat.element.group_bar_chat.ElementTalk;
import com.yugugugu.view.chat.element.group_bar_friend.ElementFriendGroup;
import com.yugugugu.view.chat.element.group_bar_friend.ElementFriendLuckUser;
import com.yugugugu.view.chat.element.group_bar_friend.ElementFriendUser;
...
public class ChatController extends ChatInit implements IChatMethod {
    ...
    public void addTalkBox(int talkIdx, Integer talkType, String talkId, String talkName, String talkHead, String talkSketch, Date talkDate, Boolean selected) {
        ...
        // 判断会话框是否有该对象
        ElementTalk elementTalk = CacheUtil.talkMap.containsKey(talkId)?CacheUtil.talkMap.get(talkId):null;
        if (null != elementTalk) {
